...
namespace slub {
  ...
  template<typename T, typename arg1 = empty, typename arg2 = empty, typename arg3 = empty>
  ...
  template<typename T>
  struct constructor<T, empty, empty, empty> : public abstract_constructor {
  ...
  struct constructor<T, arg1, empty, empty> : public abstract_constructor {
  ...
  struct constructor<T, arg1, arg2, empty> : public abstract_constructor {
