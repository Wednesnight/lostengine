...
local function miscGradients(textureManager)
  ...
  cg:add(ColorPoint(19/19, bgrey(225)))
  cg:add(ColorPoint(18/19, bgrey(221)))
  cg:add(ColorPoint(17/19, bgrey(218)))
  cg:add(ColorPoint(16/19, bgrey(214)))
  cg:add(ColorPoint(15/19, bgrey(211)))
  cg:add(ColorPoint(14/19, bgrey(207)))
  cg:add(ColorPoint(13/19, bgrey(204)))
  cg:add(ColorPoint(12/19, bgrey(201)))
  cg:add(ColorPoint(11/19, bgrey(198)))
  cg:add(ColorPoint(10/19, bgrey(195)))
  cg:add(ColorPoint(9/19, bgrey(188)))
  cg:add(ColorPoint(8/19, bgrey(185)))
  cg:add(ColorPoint(7/19, bgrey(181)))
  cg:add(ColorPoint(6/19, bgrey(179)))
  cg:add(ColorPoint(5/19, bgrey(176)))
  cg:add(ColorPoint(4/19, bgrey(173)))
  cg:add(ColorPoint(3/19, bgrey(170)))
  cg:add(ColorPoint(2/19, bgrey(165)))
  cg:add(ColorPoint(1/19, bgrey(162)))
  cg:add(ColorPoint(0/19, bgrey(11)))
