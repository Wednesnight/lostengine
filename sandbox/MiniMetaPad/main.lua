...
--  controlPanel = lost.guiro.ui():recursiveFindById("controlPanel")
  ...
  cam = lost.camera.Camera3D.create(Rect(0,0,768,1024))
  cam:depth(Vec2(0.100,2000))
  cam:position(Vec3(100,-100,100))
  cam:target(Vec3(0,0,0))
  rootNode:add(lost.rg.Camera.create(cam))

  cube = meta.Cube{color=Color(.1,.6,.0),size=50,numPlanes=10}
...
function resize(event)
  cam:viewport(Rect(0,0,768,1024))
end
