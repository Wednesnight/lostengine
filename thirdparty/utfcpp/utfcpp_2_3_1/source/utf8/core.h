...
namespace internal
{
    ...
    inline typename eastl::iterator_traits<octet_iterator>::difference_type
    ...
    utf_error validate_next(octet_iterator& it, octet_iterator end, uint32_t* code_point)
    {
        ...
        typedef typename eastl::iterator_traits<octet_iterator>::difference_type octet_difference_type;
